...
public class ProfileInfoArticleListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ProfileInfoArticleListAdapter(Activity activity, List<PojoArticlesWritten> articlesWritten) {
    ...
    private void configProgressViewHolder(ProgressBarViewHolder progressBarViewHolder, int position) {
        if (showProgress) {
    ...
    private void configItemViewHolder(ItemViewHolder holder, int position) {
        //   holder.tv_hierarchy_item.setText(hierarchyList.get(position));
