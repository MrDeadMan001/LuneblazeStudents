...
public class ProfileInfoJoinedSessionListAdapter extends RecyclerView.Adapter<ProfileInfoJoinedSessionListAdapter.MyViewHolder>{

    Activity activity;
    List<PojoSessionJoined> profileInfoSessionList;
    ...
    public ProfileInfoJoinedSessionListAdapter(Activity activity, List<PojoSessionJoined> profileInfoSessionList) {
    ...
    @Override
    public ProfileInfoJoinedSessionListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.profile_info_session_list_item, parent, false);

        return new ProfileInfoJoinedSessionListAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final ProfileInfoJoinedSessionListAdapter.MyViewHolder holder, int position) {
        //   holder.tv_hierarchy_item.setText(hierarchyList.get(position));

        final PojoSessionJoined currentItem= profileInfoSessionList.get(position);
        // holder.tv_activity_performed.setVisibility(View.GONE);
        // holder.rl_action_perf_desc_container.setVisibility(View.GONE);
        holder.tv_session_name.setText(currentItem.title);
        // holder.tv_session_description.setText(currentItem.description);
    ...
    public int getItemCount() {
        ...
        return profileInfoSessionList.size();
