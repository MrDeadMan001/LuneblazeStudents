...
import com.avadna.luneblaze.adapters.interestHierarchy.NewHierarchyListAdapter;
...
public class UpvotersAndAttendeesListAdapter extends RecyclerView.Adapter<UpvotersAndAttendeesListAdapter.MyViewHolder> {
    ...
    UpvoterAndAttendeesAdapterCallback upvoterAndAttendeesAdapterCallback;

    public UpvotersAndAttendeesListAdapter(Fragment fragment, List<PojoUserData> userList) {
        try {
            this.upvoterAndAttendeesAdapterCallback =((UpvoterAndAttendeesAdapterCallback) fragment);
        } catch (ClassCastException e) {
            throw new ClassCastException("Fragment must implement UpvoterAndAttendeesAdapterCallback.");
        }
    ...
    public UpvotersAndAttendeesListAdapter(Activity activity, List<PojoUserData> userList) {
        try {
            this.upvoterAndAttendeesAdapterCallback =((UpvoterAndAttendeesAdapterCallback) activity);
        } catch (ClassCastException e) {
            throw new ClassCastException("Activity must implement UpvoterAndAttendeesAdapterCallback.");
        }
    ...
    @Override
    public UpvotersAndAttendeesListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.user_search_list_item, parent, false);

        return new UpvotersAndAttendeesListAdapter.MyViewHolder(itemView);
    }


    @Override
    public void onBindViewHolder(final UpvotersAndAttendeesListAdapter.MyViewHolder holder, final int position) {
        ...
        if (position == userList.size()) {
            ...
            holder.tv_add_friend.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    upvoterAndAttendeesAdapterCallback.onUpvoterAndAttendeesAdapterMethod(position);
    ...
    public static interface UpvoterAndAttendeesAdapterCallback {
        void onUpvoterAndAttendeesAdapterMethod(int position);
    }
