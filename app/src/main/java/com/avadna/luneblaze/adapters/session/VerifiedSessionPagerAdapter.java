...
public class VerifiedSessionPagerAdapter extends FragmentPagerAdapter {
    ...
    public VerifiedSessionPagerAdapter(Context context, FragmentManager fm, String id, String discussion_id) {
        super(fm);
        mContext = context;
        bundle = new Bundle();
