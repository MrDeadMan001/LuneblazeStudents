...
public class PojoPost {
    ...
    @Expose
    public List<PojoPostComment> postComments = null;
    @SerializedName("qa")
    @Expose
    public PojoSearchQa qa;
    @SerializedName("session_name")
    @Expose
    public String sessionName;
    @SerializedName("photos_articles_num")
    @Expose
    public Integer photosArticlesNum;
    @SerializedName("articles_photo")
    @Expose
    public List<PojoArticlesPhoto> articlesPhoto = null;
}
