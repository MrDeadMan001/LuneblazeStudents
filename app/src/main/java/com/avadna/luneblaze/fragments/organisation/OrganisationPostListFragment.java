...
public class OrganisationPostListFragment extends Fragment implements
        ...
        mRegistrationBroadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (intent.getAction().equals(Config.ADD_NEWS_FEED_ITEM)) {
                    ...
                    hitGetOrganisationInfoApi(user_id, organisation_id, "posts", offset);
                }
            }
        };
    }
                ...
                public void onResponse(Call<PojoGetOrganisationInfoResponse> call,
                    ...
                    if (response.body() != null) {
                        ...
                        if (response.body().data != null && getActivity() != null) {
                            ...
                            tv_no_posts.setVisibility(View.GONE);
                            tv_create_post.setVisibility(View.GONE);
                            newsFeedList.addAll(response.body().data.post);
                ...
                if (newsFeedList != null) {
                    for (int i = 0; i < newsFeedList.size(); i++) {
                        if (newsFeedList.get(i).postId.equals(post_id)) {
                            newsFeedList.remove(i);
                            newsFeedAdapter.notifyDataSetChanged();
                            Intent newsFeedIntent = new Intent(Config.UPDATE_ORGANISATION_AD_LIST);
