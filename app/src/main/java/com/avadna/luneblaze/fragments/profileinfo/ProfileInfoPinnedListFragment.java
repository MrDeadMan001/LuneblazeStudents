...
public class ProfileInfoPinnedListFragment extends Fragment implements NewsFeedAdapter.NewsFeedAdapterCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        offset=0;
        hitGetUserProfileApi(user_id,targetUserId, "pinned_post",offset);
        return baseLayout;
    }
