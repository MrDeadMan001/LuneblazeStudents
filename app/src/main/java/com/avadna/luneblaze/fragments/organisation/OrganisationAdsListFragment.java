...
public class OrganisationAdsListFragment extends Fragment implements
   ...
   // private LinearLayout ll_post_box_wrapper;
    ...
    private TextView tv_no_posts, tv_create_post;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            organisation_id = getArguments().getString(AppKeys.ORGANISATION_ID);
        }
        ...
        LocalBroadcastManager.getInstance(getActivity()).registerReceiver(mRegistrationBroadcastReceiver,
                new IntentFilter(Config.UPDATE_ORGANISATION_AD_LIST));
    ...
    private void initBroadCastReceiver() {
        mRegistrationBroadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if (intent.getAction().equals(Config.UPDATE_ORGANISATION_AD_LIST)) {
                    offset = 0;
                    // hitGetNewsFeedApi(user_id, "posts_profile", currentFilter, offset, targetUserId);
                    hitGetOrganisationInfoApi(user_id, organisation_id, "ads", offset);
                }
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    ...
                    case R.id.tv_create_post:
                        ...
                        startActivityForResult(postIntent, AppKeys.CREATE_POST_REQUEST_CODE);
                ...
                public void onResponse(Call<PojoGetOrganisationInfoResponse> call,
                    ...
                    if (response.body() != null) {
                        ...
                        if (response.body().data != null && getActivity() != null) {
                            ...
                            tv_no_posts.setVisibility(View.GONE);
                            tv_create_post.setVisibility(View.GONE);
                            newsFeedList.addAll(response.body().data.ads);
                            if (newsFeedList.isEmpty()) {
                                tv_no_posts.setVisibility(View.VISIBLE);
                                tv_no_posts.setText(getString(R.string.no_ads_posted));
                            } else {
                                tv_no_posts.setVisibility(View.GONE);
                            }
                            newsFeedAdapter.notifyDataSetChanged();
