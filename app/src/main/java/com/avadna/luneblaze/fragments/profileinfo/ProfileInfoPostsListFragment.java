...
public class ProfileInfoPostsListFragment extends Fragment implements
    ...
    private void initView(View baseLayout) {
        ...
        tv_retry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                hitGetPostApi(user_id, targetUserId, "");
            }
        });
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (dy > 5) {
                    if (!isNewsFeedApiCalled
                        ...
                        hitGetPostApi(user_id, targetUserId, getLastPostId());
    ...
    private void hitGetPostApi(final String user_id, final String targetUserId, final String lastPostId) {
        Call<PojoGetNewsFeedResponse> call = apiService.hitGetMyPostApi(user_id, targetUserId, lastPostId);
        ll_no_connection_wrapper.setVisibility(View.GONE);
