...
public class AllOrganisedSessionListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LocalBroadcastManager.getInstance(getActivity()).registerReceiver(mRegistrationBroadcastReceiver,
                new IntentFilter(Config.OPEN_ORGANISED_SESSION_FILTER));
        LocalBroadcastManager.getInstance(getActivity()).registerReceiver(mRegistrationBroadcastReceiver,
        ...
        hitGetAllSessionsApi(user_id, "organized", "distance", "ASC", getLastSessionTime(),
                ...
                if (intent.getAction().equals(Config.SESSION_FILTER_UPDATED)) {
                    ...
                    if (getActivity().getClass().getSimpleName().equals(activityName)) {
                     ...
                     /*   if (oldTime.equals(TIME_DATE_RANGE)) {
                        ...
                        organisedSessionListAdapter.setShowNoMorePresent(false);
                        organisedSessionListAdapter.notifyDataSetChanged();
                        hitGetAllSessionsApi(user_id, "organized", "distance", "ASC",
                ...
                public void onResponse(Call<PojoGetAllSessionsResponse> call, Response<PojoGetAllSessionsResponse> response) {
                    ...
                    if (response.body() != null && response.body().data != null) {
                        if (last_session_time == null || last_session_time.equals("0")) {
                            organisedSessions.clear();
                            if (response.body().data.sessions.organized.isEmpty()) {
                                organisedSessionListAdapter.setShowNoMorePresent(true);
                            }

                        } else if (response.body().data.sessions.organized.size() < 10) {
                            organisedSessionListAdapter.setShowNoMorePresent(true);
                        }
    ...
    private void initSessionList(View baseLayout) {
        ...
        if (fixed_venue_id != null) {
            organisedSessionListAdapter = new OrganisedSessionListAdapter(getActivity(),
                    organisedSessions, true);
        } else {
            organisedSessionListAdapter = new OrganisedSessionListAdapter(getActivity(),
                    organisedSessions, false);
        }
        ...
        rv_session_list.setAdapter(organisedSessionListAdapter);
        ...
        rv_session_list.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                if (dy > 5) {
                    if (!isSessionApiCalled && sessionListLayoutManager.findLastCompletelyVisibleItemPosition() > organisedSessions.size() - 2) {
                        hitGetAllSessionsApi(user_id, "organized", "distance", "ASC", getLastSessionTime(),
    ...
    private String getLastSessionTime() {
        if (organisedSessions.isEmpty()) {
            ...
            return String.valueOf(organisedSessions.get(organisedSessions.size() - 1).conclusionTime);
        }
    }
