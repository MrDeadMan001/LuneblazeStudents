...
public class SharedPollActivity extends AppBaseActivity implements
    ...
    private void setUpActionBar() {
        ...
        if (actionBar != null) {
            ...
            actionBar.setBackgroundDrawable(new ColorDrawable(ContextCompat
                    .getColor(SharedPollActivity.this, R.color.action_bar_color)));
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                getWindow().setStatusBarColor(ContextCompat
                        .getColor(SharedPollActivity.this, R.color.status_bar_color));
            }
        }
    }
                ...
                switch (v.getId()) {
                    ...
                    case R.id.ib_send:
                     ...
                     /*           Calendar calendar = Calendar.getInstance();
                                ...
                                int commentsNum = Integer.parseInt(pojoNormalPostResponseData.post.comments);
                                commentsNum++;
                                pojoNormalPostResponseData.post.comments = String.valueOf(commentsNum);
        ...
        if (user_id.equals(AppKeys.GUEST_USER_ID)) {
            ...
            switch (type) {
                ...
                case AppKeys.NUM_VOTES:
                    openUserListDialog(pojoNormalPostResponseData.post.origin.postId, "voterlist");
                    break;
    ...
    public void handleApiResponse(PojoNormalPostResponse body, String comment_id, String order,
        ...
        if (body.data.post.postId.isEmpty()) {
            commonFunctions.showNotFoundDialog(SharedPollActivity.this);
        } else {
    ...
    public void showMessageDialog(String message) {
        ...
        confirmationDialog = new MyCustomThemeDialog(SharedPollActivity.this);
                ...
                public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                    ...
                    if (dy > 2) {
                        if (!isGetUpvotersApiCalled && upvoterListLayoutManager.findLastVisibleItemPosition() > upvoterList.size() - 2) {
                            hitGetUpvotersListApi(user_id, pojoNormalPostResponseData.post.origin.postId, reaction, ++upvoterListOffset);
                        }
                    }
                }
            });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.edit:
                openShareDialog("edit", pojoNormalPostResponseData.post);

              /*  Intent postCreationIntent = new Intent(SharedPollActivity.this, PostCreationActivity.class);
                ...
                startActivity(postCreationIntent);*/
                break;

            case R.id.delete:
                TextView tv_dialog_description, tv_yes, tv_no;
                final Dialog confirmationDialog = new MyCustomThemeDialog(SharedPollActivity.this);
            ...
            case R.id.share_to:
                ShareContentOnMediaApps.shareContent(SharedPollActivity.this, AppKeys.SHARE_TO_POST,
...
/*
    ...
    public void openReportDialog(final int position, final String user_id, final String type, final String id) {
        final Dialog dialog = new MyCustomThemeDialog(SharedPollActivity.this);
    ...
    public void pollPostAdapterMethod(int position, int totalVotes, PojoNewsFeedPollOption pojoNewsFeedPollOption, int newsFeedItemPosition) {
        ...
        if (pojoNormalPostResponseData.post.origin.poll != null) {
            ...
            pojoNormalPostResponseData.post.origin.origin.poll.votes = String.valueOf(totalVotes);
            pojoNormalPostResponseData.post.origin.origin.poll.options.get(position).checked = true;
            pojoNormalPostResponseData.post.origin.origin.poll.options.get(position).votes++;
        }
        setDataOnViews();
        normalPostCommentAdapter.notifyDataSetChanged();
            ...
            tv_share_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (!title.isEmpty()) {
                        ...
                        pojoNormalPostResponseData.post.postTitle = title;
                        normalPostCommentAdapter.notifyDataSetChanged();
                    } else {
                        commonFunctions.setToastMessage(getApplicationContext(),
    ...
    private void hitEditShareTitleApi(String user_id, String type, String id, String message) {
        ...
        call.enqueue(new Callback<PojoNoDataResponse>() {
            ...
            public void onResponse(Call<PojoNoDataResponse> call, Response<PojoNoDataResponse> response) {
                ...
                if (response != null && response.body() != null) {
                    message = response.body().message;
                    commonFunctions.setToastMessage(getApplicationContext(), getString(R.string.done),
                            Toast.LENGTH_LONG, AppKeys.TOAST_USER);
                }
            }
    ...
    private void hitShareContentApi(String user_id, String article_id, String reaction, String title) {
        ...
        call.enqueue(new Callback<PojoNoDataResponse>() {
            ...
            public void onResponse(Call<PojoNoDataResponse> call, Response<PojoNoDataResponse> response) {
                ...
                if (response != null && response.body() != null) {
                    message = response.body().message;
                    commonFunctions.setToastMessage(getApplicationContext(), getString(R.string.shared_poll_successfully),
                            Toast.LENGTH_LONG, AppKeys.TOAST_USER);
