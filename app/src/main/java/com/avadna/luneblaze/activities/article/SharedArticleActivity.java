...
public class SharedArticleActivity extends AppBaseActivity implements
    ...
    private NormalPostImageSliderPagerAdapter normalPostImageSliderPagerAdapter;
    private Dialog imageGalleryDialog;
    ...
    private int maxArticleImageHeight;
    ...
    private void setUpActionBar() {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(getString(R.string.shared_article));
            actionBar.setBackgroundDrawable(new ColorDrawable(ContextCompat
                    .getColor(SharedArticleActivity.this, R.color.action_bar_color)));
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                getWindow().setStatusBarColor(ContextCompat
                        .getColor(SharedArticleActivity.this, R.color.status_bar_color));
            }
        }
    ...
    private void initCommentsList() {
        ...
        normalPostCommentAdapter = new NormalPostCommentAdapter(this, commentList, "comment");
            ...
            public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                ...
                if (!listBottomEndReached && dy > 4) {
                    if (commentListLayoutManager.findLastVisibleItemPosition() > commentList.size() - 3) {
                        hitGetNormalPostApi(user_id, post_id, getOldestCommentId(), "next", "0",
                                false);
                    }
                } /*else if (dy < -4) {
    ...
    public void handleApiResponse(PojoNormalPostResponse body, String comment_id, String order,
        ...
        if (body.data.post.postId.isEmpty()) {
            commonFunctions.showNotFoundDialog(SharedArticleActivity.this);
        } else {
    ...
    public void showMessageDialog(String message) {
        ...
        confirmationDialog = new MyCustomThemeDialog(SharedArticleActivity.this, R.style.NoTitleDialogTheme);
    ...
    private void setDataOnViews() {
        ...
        if (pojoNormalPostResponseData.post.origin != null && pojoNormalPostResponseData.post.origin.origin != null) {
            //sharer data
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.edit:
                ...
                /*Intent postCreationIntent = new Intent(SharedArticleActivity.this, PostCreationActivity.class);
            ...
            case R.id.delete:
                ...
                final Dialog confirmationDialog = new MyCustomThemeDialog(SharedArticleActivity.this, R.style.NoTitleDialogTheme);
                ;
            ...
            case R.id.share_to:
                ShareContentOnMediaApps.shareContent(SharedArticleActivity.this, AppKeys.SHARE_TO_POST,
...
/*
    ...
    private void hitAddCommentApi(final String user_id, String handle, final String post_id, final String message) {
        ...
        call.enqueue(new Callback<PojoAddPostCommentResponse>() {
            ...
            public void onFailure(Call<PojoAddPostCommentResponse> call, Throwable t) {
                // Log error here since request failed
                commonFunctions.setToastMessage(getApplicationContext(),
                        getString(R.string.comment_not_added), Toast.LENGTH_LONG, AppKeys.TOAST_DEBUG);
    ...
    @Override
    public void shareNewsFeedItemClickCallback(int position, PojoGetNewsFeedResponseData currentItem,
                                               String type) {
    ...
    public void hitReportContentApi(String user_id, String report_type, String content_id, String reason) {
        ...
        call.enqueue(new Callback<PojoNoDataResponse>() {
            ...
            public void onResponse(Call<PojoNoDataResponse> call, Response<PojoNoDataResponse> response) {
                if (response != null && response.body() != null) {
                    String message = response.body().message;
                    if (SharedArticleActivity.this != null) {
                        commonFunctions.setToastMessage(getApplicationContext(), "" + message,
    ...
    public void openShareDialog(final String type, final PojoGetNewsFeedResponseData currentItem) {
        ...
        Glide.with(SharedArticleActivity.this.getApplicationContext())
    ...
    private void hitShareContentApi(String user_id, String article_id, String reaction, String title) {
        ...
        call.enqueue(new Callback<PojoNoDataResponse>() {
            ...
            public void onResponse(Call<PojoNoDataResponse> call, Response<PojoNoDataResponse> response) {
                ...
                if (response != null && response.body() != null) {
                    message = response.body().message;
                    commonFunctions.setToastMessage(getApplicationContext(), getString(R.string.shared_successfully),
                            Toast.LENGTH_LONG, AppKeys.TOAST_USER);
