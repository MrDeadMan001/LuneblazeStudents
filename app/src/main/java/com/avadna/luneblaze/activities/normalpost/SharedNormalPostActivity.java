...
public class SharedNormalPostActivity extends AppBaseActivity implements
    ...
    private List<ClickableSpan> clickableSpansList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (dataStr != null) {
            ...
            if (target_comment_id == null || target_comment_id.isEmpty()) {
                ...
                hitGetNormalPostApi(user_id, post_id, target_comment_id, "prev", "0", false);
            }
        }
    ...
    private void setUpActionBar() {
        ...
        if (actionBar != null) {
            ...
            actionBar.setBackgroundDrawable(new ColorDrawable(ContextCompat
                    .getColor(SharedNormalPostActivity.this, R.color.action_bar_color)));
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                getWindow().setStatusBarColor(ContextCompat
                        .getColor(SharedNormalPostActivity.this, R.color.status_bar_color));
            }
        }
        ...
        onClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                        ...
                        if (!et_comment.getText().toString().trim().isEmpty()) {
                            ...
                            if (!message.isEmpty()) {
                              ...
                              /*  Calendar calendar = Calendar.getInstance();
                                ...
                                //  sv_content_wrapper.smoothScrollBy(0, -99999);
                    ...
                    case R.id.ll_content_wrapper:
                        Intent intent = new Intent(SharedNormalPostActivity.this, NormalPostActivity.class);
                        intent.putExtra(AppKeys.POST_ID, pojoNormalPostResponseData.post.origin.postId);
        ...
        if(user_id.equals(AppKeys.GUEST_USER_ID)){
            ...
            switch (type) {
                case AppKeys.POST_LIKE:
                    ...
                    normalPostCommentAdapter.notifyDataSetChanged();
                    //  tv_like_number.setText(pojoNormalPostResponseData.post.likes + " " + getString(R.string.likes));
                    break;
    ...
    private void openPhotoViewerActivity(int position) {
        ...
        String dataStr = new Gson().toJson(pojoNormalPostResponseData.post.origin.photos, type);
        Intent imgViewerIntent = new Intent(SharedNormalPostActivity.this,
    ...
    public void handleApiResponse(PojoNormalPostResponse body, String comment_id, String order,
        ...
        if (body.data.post.postId.isEmpty()) {
            commonFunctions.showNotFoundDialog(SharedNormalPostActivity.this);
        } else {
    ...
    public void showMessageDialog(String message) {
        ...
        confirmationDialog = new MyCustomThemeDialog(SharedNormalPostActivity.this);
    ...
    private void setDataOnViews() {
        ...
        if (!isDataSetOnViews) {
            ...
            // tv_post_content.setMovementMethod(LinkMovementMethod.getInstance());
        }
    }
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                if (dy > 2) {
                    if (!isGetUpvotersApiCalled && upvoterListLayoutManager.findLastVisibleItemPosition() > upvoterList.size() - 2) {
                        hitGetUpvotersListApi(user_id, post_id, "post", ++upvoterListOffset);
                    }
                }
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.edit:
             ...
             /*   Intent postCreationIntent = new Intent(SharedNormalPostActivity.this, PostCreationActivity.class);
            ...
            case R.id.delete:
                ...
                final Dialog confirmationDialog = new MyCustomThemeDialog(SharedNormalPostActivity.this);
            ...
            case R.id.share_to:
                ShareContentOnMediaApps.shareContent(SharedNormalPostActivity.this, AppKeys.SHARE_TO_POST,
    ...
    private void hitShareContentApi(String user_id, String article_id, String reaction, String title) {
        ...
        call.enqueue(new Callback<PojoNoDataResponse>() {
            ...
            public void onResponse(Call<PojoNoDataResponse> call, Response<PojoNoDataResponse> response) {
                ...
                if (response != null && response.body() != null) {
                    message = response.body().message;
                    commonFunctions.setToastMessage(getApplicationContext(), getString(R.string.shared_post_successfully),
                            Toast.LENGTH_LONG, AppKeys.TOAST_USER);
                }
            }
