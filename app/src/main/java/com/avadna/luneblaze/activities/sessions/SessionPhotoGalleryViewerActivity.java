...
public class SessionPhotoGalleryViewerActivity extends AppBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionName=getIntent().getStringExtra(AppKeys.SESSION_NAME);
        setUpActionBar();
        initViews();
        initPager();
        iniClickListener();
    ...
    private void setUpActionBar() {
        ...
        if (actionBar != null) {
            ...
            actionBar.setBackgroundDrawable(new ColorDrawable(ContextCompat
                    .getColor(SessionPhotoGalleryViewerActivity.this, R.color.transparent)));
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                getWindow().setStatusBarColor(ContextCompat
                        .getColor(SessionPhotoGalleryViewerActivity.this, R.color.status_bar_color));
            }
        }
        ...
        Glide.with(context.getApplicationContext())
                ...
                .listener(new RequestListener<Bitmap>() {
                              ...
                              public boolean onResourceReady(Bitmap bitmap, Object o, Target<Bitmap> target,
                                  ...
                                  ShareContentOnMediaApps.shareContent(SessionPhotoGalleryViewerActivity.this,
                                          AppKeys.SHARE_SESSION_GALLERY_IMAGE,sessionId,sessionName,bitmap);
                                  return false;
                              }
                          }
                ).submit();
