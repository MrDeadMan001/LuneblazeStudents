...
//todo replace all recyclerview  with listview 8 items max

public class SessionCreationFormActivity extends AppBaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_session_creation_form);
    ...
    private void setUpActionBar() {
        ...
        if (actionBar != null) {
            ...
            actionBar.setBackgroundDrawable(new ColorDrawable(ContextCompat
                    .getColor(SessionCreationFormActivity.this, R.color.action_bar_color)));
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                getWindow().setStatusBarColor(ContextCompat
                        .getColor(SessionCreationFormActivity.this, R.color.status_bar_color));
            }
        }
    }
    ...
    private void updateSelectedInterestList() {
        gridLayoutManager = (new GridLayoutManager(SessionCreationFormActivity.this, 200));
        ...
        taggedInterestAdapter = new TaggedInterestAdapter(selectedInterestList.size(),SessionCreationFormActivity.this, selectedInterestList,2);
    ...
    private void initDiscussionTopicList() {
        ...
        rv_discussion_topics_list.setLayoutManager
                (new LinearLayoutManager(SessionCreationFormActivity.this,
                        LinearLayoutManager.VERTICAL, false));
        rv_discussion_topics_list.setNestedScrollingEnabled(false);
        discussionTopicListAdapter = new OrganisedSessionTopicsListAdapter(SessionCreationFormActivity.this,
    ...
    private void initPreRequisiteList() {
        ...
        preRequisitesListAdapter = new OrganisedSessionTopicsListAdapter(SessionCreationFormActivity.this,
    ...
    private void initInterestResultList() {
        ...
        interestSearchResultAdapter = new InterestSearchResultAdapter(SessionCreationFormActivity.this, interestSearchResultList);
    ...
    private void initVenueResultList() {
        ...
        venueResultsListAdapter = new VenueSearchResultAdapter(SessionCreationFormActivity.this,venueSearchResultList);
    ...
    private void initPurposeListSpinner() {
        ...
        purposeSpinnerAdapter = new ArrayAdapter<String>(SessionCreationFormActivity.this, R.layout.custom_spinner_dropdown_item, purpose_options);
    ...
    private void openDatePickerDialogBox(final int i) {
        ...
        DatePickerDialog mDatePickerDialog = new DatePickerDialog(SessionCreationFormActivity.this, new DatePickerDialog.OnDateSetListener() {
            @Override
    ...
    public void openAddDisscussionDialog() {
        ...
        final Dialog dialog = new MyCustomThemeDialog(SessionCreationFormActivity.this);
            ...
            call.enqueue(new Callback<PojoSearchInterestWithTextResponse>() {
                ...
                public void onResponse(Call<PojoSearchInterestWithTextResponse> call, Response<PojoSearchInterestWithTextResponse> response) {
                    ...
                    if (response.body().data != null) {
                        ...
                        commonFunctions.setToastMessage(SessionCreationFormActivity.this, "" + message,
                ...
                public void onFailure(Call<PojoSearchInterestWithTextResponse> call, Throwable t) {
                    ...
                    commonFunctions.setToastMessage(SessionCreationFormActivity.this, t.toString(),
                            Toast.LENGTH_LONG,AppKeys.TOAST_DEBUG);
            ...
            call.enqueue(new Callback<PojoGetVenueListResponse>() {
                ...
                public void onResponse(Call<PojoGetVenueListResponse> call, Response<PojoGetVenueListResponse> response) {
                    ...
                    if (response.body().data != null) {
                        ...
                        commonFunctions.setToastMessage(SessionCreationFormActivity.this, "" + message, Toast.LENGTH_LONG,AppKeys.TOAST_DEBUG);
                    }
                ...
                public void onFailure(Call<PojoGetVenueListResponse> call, Throwable t) {
                    // Log error here since request failed
                    commonFunctions.setToastMessage(SessionCreationFormActivity.this, t.toString(), Toast.LENGTH_LONG,AppKeys.TOAST_DEBUG);
